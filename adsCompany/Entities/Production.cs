...
namespace adsCompany.Entities
{
    ...
    public class ProductionConfiguration : IEntityTypeConfiguration<Production>
    {
        public void Configure(EntityTypeBuilder<Production> builder)
        {
            ...
            //Foregin key
            builder.HasOne(x => x.ProductionType).WithMany().HasForeignKey(x => x.ProductionTypeId).OnDelete(DeleteBehavior.Restrict).HasConstraintName("FK_ProductionTypes_Productions");
